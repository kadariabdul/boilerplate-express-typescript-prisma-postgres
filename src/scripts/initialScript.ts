  ...
  try {
    const products = [
      ...
      },
      {
        ...
        description: "100% POLYURETHANE(shell) 100% POLYESTER(lining) 75% POLYESTER 25% COTTON (SWEATER), Faux leather material for style and comfort / 2 pockets on the front, 2-For-One Hooded denim style faux leather jacket, Button detail on the waist / Detail stitching at sides, HAND WASH ONLY / DO NOT BLEACH / LINE DRY / DO NOT IRON",
        category: "women's clothing",
        price: 29,
      ...
      },
      {
        ...
        description: "95% RAYON 5% SPANDEX, Made in USA or Imported, Do Not Bleach, Lightweight fabric with great stretch for comfort, Ribbed on sleeves and neckline / Double stitching on the bottom hem",
        category: "women's clothing",
        price: 9,
